	...
	<div class="form">
		...
		<div class="tab-content">
			<div id="signup">
				...
				<form action="rest/login" method="post" onsubmit="return UserValidateDetails">
			...
			<div id="login">
				...
				<form action="/MiniProject/rest/login" method="post" onsubmit="return validateDetails">
				 ...
				 <div class="g-signin2" id="googleSignInButton" style="margin:0 auto"data-onsuccess="onSignIn"></div></button>  
